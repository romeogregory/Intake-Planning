<footer class="footer-wrap-layout8">
    <div class="footer-top-layout8">
        <div class="container">
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                    <div class="footer-widgets">
                        <div class="footer-logo">
                            <a href="index.html"><img src="frontend/media/logo-footer.png" alt="Logo"></a>
                        </div>
                        <p class="about-paragraph">Grursus mal suada faci Lorem to the ipsum dolarorit more
                            ametion more
                            consectetur elit.</p>
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-12">
                    <div class="footer-widgets">
                        ...
                        <ul class="footer-contact">
                            ...
                            <li><i class="flaticon-plane"></i><a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                    data-cfemail="9cf5f2faf3dce5f3e9eef8f3f1fdf5f2b2fff3f1">[email&#160;protected]</a>
                            </li>
    ...
    <div class="footer-bottom-layout8">
        <div class="container">
            <div class="copy-right-wrap">
                <p class="copy-right-text">© 2020 <a href="https://www.radiustheme.com" rel="nofollow"
                        target="_blank">RadiusTheme.</a> All Rights Reserved</p>
            </div>
        </div>
    </div>
</footer>
