                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="password"
                                                        ...
                                                        placeholder="{{ __('fields.password') }}" required autofocus>
                                            ...
                                            <div class="form-group mb-0 row">
                                                <div class="col-12">
                                                    <button class="btn btn-primary btn-block waves-effect waves-light"
                                                        type="submit">{{ __('reset-password.reset') }} <i
                                                            class="fas fa-lock ml-1"></i></button>
                                                </div>
                                                <!--end col-->
                                            </div>
                                            <!--end form-group-->
