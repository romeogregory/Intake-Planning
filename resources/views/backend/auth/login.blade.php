                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active p-3" id="LogIn_Tab" role="tabpanel">
                                            ...
                                            <div class="form-group mb-2">
                                                ...
                                                <div class="input-group">
                                                    <input type="password"
                                                        ...
                                                        placeholder="{{ __('fields.password') }}" required>
                                                    @error('password')
                                                    <div>{{ $message }}</div>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="custom-control custom-switch">
                                                        ...
                                                        <label class="custom-control-label text-muted"
                                                            for="customSwitchSuccess">{{ __('login.remember_me') }}</label>
                                                    </div>
                                                </div>
                                                <!--end col-->
                                                <div class="col-sm-6 text-right">
                                                    <a href="/forgot-password" class="text-muted font-13"><i
                                                            class="dripicons-lock"></i>
                                                        {{ __('login.forgot_password') }}</a>
                                                </div>
                                                <!--end col-->
                                            </div>
                                            <!--end form-group-->
                                        ...
                                        <div class="m-3 text-center text-muted">
                                            <p class="mb-0">{!! __('login.text_1') !!}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
