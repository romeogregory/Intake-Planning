...
@section('pagename') Blank @endsection
@section('css')
<link href="{{URL::asset('backend/assets/plugins/fullcalendar/packages/core/main.css')}}" rel="stylesheet" />
<link href="{{URL::asset('backend/assets/plugins/fullcalendar/packages/daygrid/main.css')}}" rel="stylesheet" />
<link href="{{URL::asset('backend/assets/plugins/fullcalendar/packages/bootstrap/main.css')}}" rel="stylesheet" />
<link href="{{URL::asset('backend/assets/plugins/fullcalendar/packages/timegrid/main.css')}}" rel="stylesheet" />
<link href="{{URL::asset('backend/assets/plugins/fullcalendar/packages/list/main.css')}}" rel="stylesheet" />
<link href="{{URL::asset('backend/assets/plugins/lightpick/lightpick.css')}}" rel="stylesheet" />
@endsection
@section('content')
<div class="row">  
    <div class="col-12">
...
@endsection
@section('js')
<script src='{{URL::asset('backend/assets/plugins/fullcalendar/packages/core/main.js')}}'></script>
<script src='{{URL::asset('backend/assets/plugins/fullcalendar/packages/daygrid/main.js')}}'></script>
<script src='{{URL::asset('backend/assets/plugins/fullcalendar/packages/timegrid/main.js')}}'></script>
<script src='{{URL::asset('backend/assets/plugins/fullcalendar/packages/interaction/main.js')}}'></script>
<script src='{{URL::asset('backend/assets/plugins/fullcalendar/packages/list/main.js')}}'></script>
<script src="{{URL::asset('backend/assets/plugins/lightpick/lightpick.js')}}"></script>
{!! $calendar->script() !!}
@endsection
