                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-dark o_px o_py-md o_br-t o_sans o_text" align="center"
                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #0c213a;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
                                    <p style="margin-top: 0px;margin-bottom: 0px;"><a class="o_text-white"
                                            href="https://serointech.com/"
                                            style="text-decoration: none;outline: none;color: #ffffff;"><img
                                                src="{{URL::asset('mail/images/logo2.png')}}" width="200" height="36"
                                                alt="Serointech"
                                                style="max-width: 200px;-ms-interpolation-mode: bicubic;vertical-align: middle;border: 0;line-height: 100%;height: auto;outline: none;text-decoration: none;"></a>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-primary o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white"
                                    align="center"
                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 19px;line-height: 28px;background-color: #0f2541;color: #ffffff;padding-left: 24px;padding-right: 24px;padding-top: 64px;padding-bottom: 64px;">
                                    <h1 class="o_heading o_mb-xxs"
                                        style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;font-size: 36px;line-height: 47px;">
                                        {{ __('mail.intake_confirm_title') }}</h1>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">{{ __('mail.intake_confirm_sec_title') }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <h4 class="o_heading o_text-dark o_mb-xs"
                                        ...
                                        {{ __('mail.intake_confirm_text', ['name' => $mail_data['name'], 'lastname' =>$mail_data['lastname']]) }},</h4>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">{!! __('mail.intake_confirm_text_2') !!}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text-xs o_text-light" align="center"
                                    ...
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><strong>{{ __('fields.company_name') }}</strong></p>
                                            ...
                                            <tr>
                                                <td width="284"
                                                    ...
                                                    <p class="o_text-dark"
                                                        ...
                                                        <strong>{{ $mail_data['company_name'] }}</strong></p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                            ...
                            <tbody>
                                <tr>
                                    <td class="o_bg-white o_px-md o_py o_sans o_text-xs o_text-light" align="center"
                                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #ffffff;color: #82899a;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                                        <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><strong>{{ __('fields.explanation') }}</strong></p>
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tbody>
                                                <tr>
                                                    <td width="284"
                                                        class="o_bg-ultra_light o_br o_text-xs o_sans o_px-xs o_py"
                                                        align="center"
                                                        style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;width:500px;font-size: 14px;line-height: 21px;background-color: #ebf5fa;border-radius: 4px;padding-left: 8px;padding-right: 8px;padding-top: 16px;padding-bottom: 16px;">
                                                        <p class="o_text-dark"
                                                            style="color: #242b3d;margin-top: 0px;margin-bottom: 0px;">
                                                            <strong style="color: #242b3d">{!! $mail_data['explanation'] !!}</strong>
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
            ...
            <tr>
                <td class="o_bg-light o_px-xs o_pb-lg o_xs-pb-xs" align="center"
                    ...
                    <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation"
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-dark o_px-md o_py-lg o_br-b o_sans o_text-xs o_text-dark_light"
                                    align="center"
                                    style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;background-color: #0c213a;color: #a0a3ab;border-radius: 0px 0px 4px 4px;padding-left: 24px;padding-right: 24px;padding-top: 32px;padding-bottom: 32px;">
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;"><a
                                            ...
                                            style="text-decoration: none;outline: none;color: #a0a3ab;"><img
                                                src="{{URL::asset('mail/images/logo.png')}}" width="36" height="36"
                                                alt="SimpleApp"
                                    ...
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">©{{ now()->year }}
                                        {{ config('app.name') }}</p>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">
                                        <a class="o_text-dark_light o_underline" href="https://serointech.com/contact"
                                            style="text-decoration: underline;outline: none;color: #a0a3ab;">{{ __('menu.contact') }}</a>
                                        ...
                                        <a class="o_text-dark_light o_underline" href="http://dash.serointech.com/"
                                            style="text-decoration: underline;outline: none;color: #a0a3ab;">{{ __('menu.dashboard') }}</a>
                                        <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg"
                                            style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
                                        <a class="o_text-dark_light o_underline" href="https://serointech.com/"
                                            style="text-decoration: underline;outline: none;color: #a0a3ab;">{{ __('menu.home') }}</a>
                                    </p>
                                </td>
                            </tr>
                        </tbody>
