                            ...
                            <tr>
                                <td class="o_bg-ultra_light o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-light"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="o_bb-primary" height="40" width="32"
                                                    style="border-bottom: 1px solid #0c213a;">&nbsp; </td>
                                                <td rowspan="2" class="o_sans o_text o_text-secondary o_px o_py"
                                                    ...
                                                    <img src="{{URL::asset('mail/images/email-primary.png')}}"
                                    ...
                                    <h2 class="o_heading o_text-dark o_mb-xxs"
                                        ...
                                        {{ __('mail.verify_title') }}</h2>
                                    <p style="margin-top: 0px;margin-bottom: 0px;">{{ __('mail.verify_sec_title') }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text-xs o_text-light" align="center"
                                    ...
                                    <p class="o_mb" style="margin-top: 0px;margin-bottom: 16px;">
                                        <strong>{{ __('mail.verify_text_1') }}</strong></p>
                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                            <tr>
                                                <td width="284"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td width="300" class="o_btn o_bg-primary o_br o_heading o_text"
                                                    align="center"
                                                    style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;mso-padding-alt: 12px 24px;background-color: #0c213a;border-radius: 4px;">
                                                    <a class="o_text-white" href="{{ $url }}"
                                                        style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">{{ __('mail.verify_button') }}</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <tbody>
                            <tr>
                                <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center"
                                    ...
                                    <p style="margin-top: 0px;margin-bottom: 0px;">{{ __('mail.verify_text_2') }}</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
